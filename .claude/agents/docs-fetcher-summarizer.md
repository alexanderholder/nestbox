...
- Identify the specific library/framework (e.g., Rails 8)
...
- Verify correct version of the documentation is being used (e.g. no Rails 7 examples in Rails 8 documentation)
